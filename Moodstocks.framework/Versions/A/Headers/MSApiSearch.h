...
/** The operation error, or `nil` if the operation succeeded.
 *
 * This must be checked as soon as the result block is called.
 * If the operation has been cancelled the error code is `MSErrorAbort`.
...
/** The operation result, or `nil` if no match was found or an error occurred.
 *
